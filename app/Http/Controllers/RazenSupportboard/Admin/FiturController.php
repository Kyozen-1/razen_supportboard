...
class FiturController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('razen-supportboard.admin.fitur.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => 'Berhasil menambahkan Fitur']);
    }
    ...
    {
        return response()->json(['result' => Fitur::find($id)]);
    }
    ...
    public function update(Request $request)
    {
        ...
        $fitur = Fitur::find($request->hidden_id);
        $fitur->judul = $request->judul;
        $fitur->deskripsi = $request->deskripsi;
        $fitur->save();
