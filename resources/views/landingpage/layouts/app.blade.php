                ...
                <div class="header-body border-top-0 appear-animation" data-appear-animation="fadeIn">
                    ...
                    <div class="container">
                        ...
                        <div class="header-column justify-content-start">
                            ...
                            <nav class="header-nav-top">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a href="mailto:hello@razen.co.id" class="text-color-default text-color-hover-primary">hello@razen.co.id</a>
                                    </span>
                                </li>
                                <li class="nav-item d-none d-md-block">
                                    <span class="ws-nowrap custom-text-color-grey-1 text-2">
                                    <i class="icon-clock icons text-4 top-3 left-1 me-1"></i> Senin - Jumat 09:00 - 18:00 </span>
                                </li>
                                </ul>
                            </nav>
                            </div>
                        ...
                        <div class="header-column justify-content-end">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=6282299449494&amp;text=Hai%20Razen%20Teknologi,%20Saya%20dengan%20:................%20%20Dari%20:................%20Keperluan::................" class="btn btn-tertiary font-weight-semibold text-3 px-4 custom-height-1 rounded-0 align-items-center d-none d-md-flex text-color-light">
                                <i class="icon-phone icons text-4 me-2"></i> +62 822-9944-9494 </a>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="header-row p-relative px-0">
                        ...
                        <div class="header-row">
                            ...
                            <a href="index.html">
                                <img alt="Razen GET ERP" src="https://tech.razen.co.id/solusi/swasta/img/logos/get-erp-razen.png" height="50">
                            </a>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="header-row justify-content-end justify-content-lg-start">
                            ...
                            <div class="header-nav-main header-nav-main-square header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                ...
                                <ul class="nav nav-pills" id="mainNav">
                                    <li>
                                    <a class="nav-link active current-page-active" href="index.html"> GET ERP </a>
                                    </li>
                                    <li class="dropdown">
                                    <a class="dropdown-item dropdown-toggle" href="#"> Demo Aplikasi <i class="fas fa-chevron-down"></i>
                                    </a>
                                    ...
                                    <a class="dropdown-item dropdown-toggle active current-page-active" href="#"> Solusi Lainnya <i class="fas fa-chevron-down"></i>
                                    ...
                                    <li>
                                    <a class="nav-link" href="https://api.whatsapp.com/send?phone=6282299449494&amp;text=Hai%20Razen%20Teknologi,%20Saya%20dengan%20:................%20%20Dari%20:................%20Keperluan::................"> Kontak Kami </a>
                                    </li>
                                </ul>
                                </nav>
                            </div>
                            ...
                            <div class="header-nav-feature header-nav-features-search d-inline-flex">
                                ...
                                <a class="btn btn-outline-primary font-weight-semibold text-3 py-3 border-radius p-relative bottom-1 custom-header-1-btn-1" href="https://api.whatsapp.com/send?phone=6282299449494&amp;text=Halo%20kak,%20saya%20ingin%20membahas%20sebuah%20proyek" target="_blank">
              ...
              <div class="container position-relative mt-0 mb-4">
                <div class="row py-5">
                  <div class="col-lg-3 mb-5 mb-lg-0">
                    ...
                    <a href="index.html">
                      <img src="../templates/corporate/logo.svg" class="img-fluid" alt="">
                    </a>
                  </div>
                  ...
                  <div class="col-lg-3">
                    ...
                    <ul class="list list-unstyled">
                      <li class="mb-1"> Address: Jl. Lowanu No.34-33, Kota Yogyakarta 55153 </li>
                      <li class="mb-1"> Phone: <a href="https://api.whatsapp.com/send?phone=6282299449494&amp;text=Hai%20Razen%20Teknologi,%20Saya%20dengan%20:................%20%20Dari%20:................%20Keperluan::................">+62 822-9944-9494</a>
                      </li>
                      <li class="mb-1"> Email: <a href="#">hello@razen.co.id</a>
                      </li>
                    </ul>
              ...
              <div class="footer-copyright bg-color-tertiary">
                <div class="container py-2">
                  ...
                  <div class="row justify-content-center py-4">
                    <div class="col-auto">
                      <p class="text-color-light opacity-5 text-3">Razen Technology © Copyright 2023. All Rights Reserved.</p>
                    </div>
                  </div>
                </div>
              </div>
