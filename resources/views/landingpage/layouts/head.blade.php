...
<!-- Favicon -->
<link rel="shortcut icon" href="{{ asset('images/razen-supportboard/logo/'.$profil->logo_kecil) }}">
<link rel="apple-touch-icon" href="{{ asset('images/razen-supportboard/logo/'.$profil->logo_kecil) }}">
<!-- Mobile Metas -->
