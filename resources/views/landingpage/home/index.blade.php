...
@section('content')
        ...
        <div class="row align-items-center">
            ...
            <div class="row align-items-center">
                ...
                <div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="850">
                    <div class="custom-dots-rect-1" style="background-image: url(https://razenteknologi.com/solusi/get-erp-razen/img/dots-group.png);"></div>
                    <div class="card-body text-center pt-5">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/icons/target.svg" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" data-icon="" data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}">
                    <h4 class="text-color-dark font-weight-semibold mb-2">Kelola SDM - Aset Terbesar Bisnis </h4>
                    <p>Solusi all-in-one pengelolaan HR / SDM bisnis.</p>
                    </div>
                </div>
                <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4">
                    <div class="card-body text-center pt-5">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/icons/search.svg" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" data-icon="" data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}">
                    <h4 class="text-color-dark font-weight-semibold mb-2">Integrasi dengan aplikasi</h4>
                    <p>Jadwalkan rapat Zoom dengan mudah dan sinkronkan detail rapat. Dapatkan notifikasi proyek yang dikirim langsung ke aplikasi Telegram Anda secara real-time. Berkolaborasi lebih baik dengan anggota tim, dan tetap up-to-date dengan proyek Anda.</p>
                    </div>
                </div>
                </div>
                <div class="col-md-6">
                <div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
                    <div class="custom-dots-rect-2" style="background-image: url(https://razenteknologi.com/solusi/get-erp-razen/img/dots-group-2.png);"></div>
                    <div class="card-body text-center pt-5">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/icons/teaching.svg" class="img-fluid mb-4 pb-2" width="70" height="70" alt="" data-icon="" data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}">
                    <h4 class="text-color-dark font-weight-semibold mb-2">Manajemen Akuntansi dan Tagihan</h4>
                    <p>Tetap patuh dan laporkan keuangan Anda secara akurat. Dapatkan daftar aset, liabilitas, pengeluaran, pendapatan, ekuitas, tetapkan tujuan keuangan, dan buat mereka dilacak secara otomatis berdasarkan catatan keuangan.</p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <h2 class="text-color-dark font-weight-semibold text-6 line-height-3 pt-5 mt-5 mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">DAPATKAN SEMUA ALAT PENTING UNTUK PENGELOLAAN KEUANGAN BISNIS</h2>
            <p class="lead appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Solusi all-in-one pengelolaan bisnis.</p>
            <p class="mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750">Sederhanakan pekerjaan anda, dan bawa bisnis anda ke tingkat berikutnya.</p>
    ...
    <section class="section custom-bg-color-light-2 position-relative border-0 pt-4 m-0">
        ...
        <div class="row text-center align-items-center pb-4 pt-lg-4 mb-3 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
            ...
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-1.png" class="img-fluid" alt="" style="max-width: 90px;">
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-2.png" class="img-fluid" alt="" style="max-width: 130px;">
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-3.png" class="img-fluid" alt="" style="max-width: 130px;">
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-4.png" class="img-fluid" alt="" style="max-width: 130px;">
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-5.png" class="img-fluid" alt="" style="max-width: 120px;">
            </div>
            <div class="col-md-4 col-lg-2">
            <img src="https://razenteknologi.com/solusi/get-erp-razen/img/logos/logo-1.png" class="img-fluid" alt="" style="max-width: 130px;">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <h2 class="text-color-dark font-weight-semibold text-6 line-height-3 mb-0 pe-5 me-5">Dapatkan Semua Fitur dalam Satu Aplikasi dengan harga terjangkau.</h2>
            <p class="lead pe-5 mb-4 pb-2">Achieve More in Less Time.</p>
            <div class="feature-box">
                ...
                <h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Kelola semua urusan karyawan dengan Razen GET ERP </h4>
                <p class="mb-0">Mempekerjakan 5, 50, atau 500 orang, dengan GET ERP, Anda dapat mengelola semua urusan karyawan. Dari perekrutan hingga kinerja dan gaji - semuanya berada di bawah satu atap</p>
                </div>
            </div>
            <div class="feature-box">
                ...
                <h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Sesuaikan sistem HRM Anda yang mudah digunakan</h4>
                <p class="mb-0">Sistem HRM lengkap yang dapat disesuaikan, serbaguna, dan mudah digunakan. Anda juga dapat mengatur Kehadiran, Kehadiran Massal, Liburan, Cuti, Rapat, Aset, Dokumen, dan Kebijakan Perusahaan. Buat, Edit, dan Filter sesuai kenyamanan Anda.</p>
                </div>
            </div>
            </div>
            <div class="col-lg-6 text-center text-lg-start">
            <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/apphero2.png">
                <img src="https://razenteknologi.com/solusi/get-erp-razen/img/apphero2.png" class="img-fluid appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600" alt="">
            </a>
            </div>
        </div>
        </div>
    ...
    <section class="section bg-color-light position-relative border-0 pt-0 m-0">
        ...
        <div class="row justify-content-center mb-4">
            ...
            <div class="overflow-hidden mb-2">
                <h2 class="font-weight-bold text-color-quaternary text-7 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="350">Fitur</h2>
            </div>
            <p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500"> MAKSIMALKAN SUMBERDAYA ANDA, TERHUBUNG DENGAN PELANGGAN ANDA, DAN JADILAH LEBIH PRODUKTIF</p>
            </div>
        </div>
        <div class="row justify-content-center pb-2 mb-4">
            ...
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
                <div class="custom-dots-rect-3" style="background-image: url(https://razenteknologi.com/solusi/get-erp-razen/img/dots-group-3.png);"></div>
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Manajemen Staff &amp; HR</h4>
                <p>Melacak informasi karyawan dengan mudah dan nyaman. Cari staf melalui opsi filter sederhana, dan edit serta kelola informasi mereka sesuka Anda.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Pelacakan Proyek</h4>
                <p>Buat timesheet untuk tetap di atas tenggat waktu. Lacak waktu yang dihabiskan untuk setiap proyek, dan dapatkan ikhtisar tentang berapa banyak waktu yang tersisa.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Perencana Anggaran</h4>
                <p>Tetap kendalikan keuangan anda! Tetapkan anggaran Anda dan dapatkan pembaruan waktu nyata tentang seberapa baik Anda menaatinya. Edit dan perbarui anggaran sesering yang diperlukan.</p>
                </div>
            </div>
            </div>
            ...
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Manajemen Laporan</h4>
                <p>Dapatkan laporan terperinci dan real-time untuk membantu Anda melacak kinerja bisnis Anda. Gunakan grafik dan visual lainnya untuk membuat data mudah dipahami dan ditindaklanjuti.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Event &amp; Papan pengumuman</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Manajemen Prospek</h4>
                <p>Dapatkan informasi real-time tentang prospek yang dihasilkan melalui divisi marketing Anda.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Manajemen Penjualan</h4>
                <p>Jaga agar proses penjualan Anda teratur. Edit dan kelola faktur, pembayaran, pengeluaran, dan nota dengan mudah.</p>
                </div>
            </div>
            </div>
            ...
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Integrasi Zoom, Slack &amp; Telegram</h4>
                <p>Jadwalkan rapat Zoom dengan mudah dan sinkronkan detail rapat. Dapatkan pemberitahuan real-time tentang aktivitas perusahaan di channel Slack Anda</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">Manajemen Gaji</h4>
                <p>Sederhanakan tugas penggajian Anda. Buat karyawan Anda senang dengan slip gaji yang akurat dan tepat waktu. Hasilkan pembayaran massal dengan cepat dan mudah.</p>
                </div>
            </div>
            <div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
                <div class="card-body text-center p-5">
                <h4 class="text-color-dark font-weight-semibold mb-3">KPI (Key Performance Indicator)</h4>
                <p>Pemilik lahan atau petani perawat lahan bisa melaporkan aktifitas aktifitas yang dikerjakan tiap hari atau minggu, sebagai bentuk dokumentasi, foto, peta utk investor.</p>
                </div>
            </div>
            </div>
        </div>
    ...
    <section class="section section-height-4 bg-color-quaternary position-relative border-0 pt-5 m-0">
        ...
        <div class="row justify-content-center mb-3">
            ...
            <div class="overflow-hidden mb-2">
                <h2 class="font-weight-bold text-color-light text-7 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="250">Sudah punya website ? Tapi bermasalah ??</h2>
            </div>
            <div class="overflow-hidden mb-1">
                <p class="lead text-color-light mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Yuk pakai produk kami</p>
            </div>
            <div class="overflow-hidden mb-3">
                <p class="text-color-light mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="550">Menyediakan sistem informasi yang pas untuk kebutuhan anda</p>
            </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container position-relative pb-lg-5 mb-5">
        ...
        <div class="col">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <a class="nav-link active" href="#tabsNavigationSimpleIcons1" data-bs-toggle="tab" aria-selected="true" role="tab">
                    ...
                    <p class="mb-0 pb-0">Real-time Dashboard</p>
                </a>
                </li>
                <li class="nav-item" role="presentation">
                <a class="nav-link" href="#tabsNavigationSimpleIcons2" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">
                    <span class="featured-boxes featured-boxes-style-6 p-0 m-0">
                    <span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
                        <span class="box-content p-0 m-0">
                        <i class="icon-featured fas fa-location"></i>
                        </span>
                    </span>
                    </span>
                    <p class="mb-0 pb-0">Sistem PoS</p>
                </a>
                </li>
                <li class="nav-item" role="presentation">
                <a class="nav-link" href="#tabsNavigationSimpleIcons3" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">
                    <span class="featured-boxes featured-boxes-style-6 p-0 m-0">
                    <span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
                        <span class="box-content p-0 m-0">
                        <i class="icon-featured fas fa-money-bills"></i>
                        </span>
                    </span>
                    </span>
                    <p class="mb-0 pb-0">Kalender Proyek/Tugas</p>
                </a>
                </li>
                <li class="nav-item" role="presentation">
                <a class="nav-link" href="#tabsNavigationSimpleIcons4" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">
                    <span class="featured-boxes featured-boxes-style-6 p-0 m-0">
                    <span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
                        <span class="box-content p-0 m-0">
                        <i class="icon-featured fas fa-briefcase"></i>
                        </span>
                    </span>
                    </span>
                    <p class="mb-0 pb-0">Sistem Neraca Keuangan</p>
                </a>
                </li>
                <li class="nav-item" role="presentation">
                <a class="nav-link" href="#tabsNavigationSimpleIcons5" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">
                    <span class="featured-boxes featured-boxes-style-6 p-0 m-0">
                    <span class="featured-box featured-box-primary featured-box-effect-6 p-0 m-0">
                        <span class="box-content p-0 m-0">
                        <i class="icon-featured fa fa-mobile-alt"></i>
                        </span>
                    </span>
                    </span>
                    <p class="mb-0 pb-0">Integrasi di setiap perangkat</p>
                </a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tabsNavigationSimpleIcons1" role="tabpanel">
                <div class="row">
                    <div class="col-4">
                    <div class="text-center">
                        <p>Dalam real-time dashboard, data bisnis penting ditampilkan dalam bentuk grafik dan tabel yang interaktif dan mudah dipahami. Fitur ini memudahkan <a href="#">manajer</a> dalam melihat kinerja bisnis mereka dalam waktu nyata dan membuat keputusan yang tepat dan strategis. Selain itu, real-time dashboard juga dapat membantu karyawan dalam memantau kinerja mereka dan mengambil tindakan yang diperlukan. </p>
                    </div>
                    </div>
                    <div class="col-8">
                    <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/fitur1.png">
                        <img src="https://razenteknologi.com/solusi/get-erp-razen/img/fitur1.png" class="img-fluid position-relative z-index-1 pb-5 mb-5 ms-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="row">
                    <div class="col-4">
                    <div class="text-center">
                        <p>Fitur ini memungkinkan perusahaan untuk mengelola penjualan dan stok produk langsung terintegrasi pada sistem ERP. Dalam sistem ERP, sistem PoS dapat terintegrasi dengan modul penjualan dan inventaris.</p>
                        <p>Sistem PoS dalam sistem ERP juga memudahkan perusahaan dalam melacak penjualan dan memonitor kinerja penjualan mereka. Data penjualan dapat dihasilkan secara <a href="#">otomatis</a> dan tersedia dalam bentuk laporan yang dapat dipantau oleh manajer. Hal ini dapat membantu perusahaan dalam membuat keputusan yang tepat dan strategis terkait dengan penjualan dan inventaris. Dengan menggunakan sistem PoS dalam sistem ERP, perusahaan dapat meningkatkan efisiensi dan produktivitas dalam mengelola penjualan dan inventaris mereka. </p>
                    </div>
                    </div>
                    <div class="col-8">
                    <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/fitur2.png">
                        <img src="https://razenteknologi.com/solusi/get-erp-razen/img/fitur2.png" class="img-fluid position-relative z-index-1 pb-5 mb-5 ms-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="">
                    </a>
                    </div>
                </div>
                </div>
                <div class="tab-pane" id="tabsNavigationSimpleIcons3" role="tabpanel">
                <div class="row">
                    <div class="col-4">
                    <div class="text-center">
                        <p>Dalam sistem ERP, proyek-proyek dapat dimonitor secara real-time melalui kalender yang terintegrasi dengan modul proyek. Setiap <a href="#">aktivitas proyek</a>, seperti tugas, tenggat waktu, dan anggaran dapat dicatat dan dipantau melalui kalender. Fitur ini memudahkan manajer proyek untuk melihat jadwal proyek secara keseluruhan dan memastikan bahwa semua tugas dan aktivitas dilakukan tepat waktu. </p>
                        <p> Dengan menggunakan tracking proyek dalam kalender ERP, perusahaan dapat meningkatkan efisiensi dan produktivitas dalam mengelola proyek. </p>
                    </div>
                    </div>
                    <div class="col-8">
                    <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/fitur3.png">
                        <img src="https://razenteknologi.com/solusi/get-erp-razen/img/fitur3.png" class="img-fluid position-relative z-index-1 pb-5 mb-5 ms-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="">
                    </a>
                    </div>
                </div>
                </div>
                <div class="tab-pane" id="tabsNavigationSimpleIcons4" role="tabpanel">
                <div class="row">
                    <div class="col-4">
                    <div class="text-center">
                        <p> Neraca keuangan terdiri dari dua bagian utama: aktiva dan kewajiban serta ekuitas. <a href="#">Bagian aktiva</a> mencakup semua sumber daya yang dimiliki oleh perusahaan, seperti kas, piutang, inventaris, dan aset tetap. <a href="#">Bagian kewajiban</a> dan ekuitas mencakup semua hutang yang dimiliki oleh perusahaan, seperti hutang dagang, hutang pajak, dan pinjaman bank, serta ekuitas pemilik, seperti saham dan laba ditahan. Dengan menggunakan neraca keuangan dalam <a href="#">sistem ERP</a>, neraca keuangan dapat dihasilkan secara otomatis dengan menggunakan data keuangan yang tercatat dalam sistem. Hal ini dapat membantu perusahaan dalam memantau keuangan perusahaan secara real-time dan membuat keputusan yang tepat dan strategis. </p>
                    </div>
                    </div>
                    <div class="col-8">
                    <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/fitur4.png">
                        <img src="https://razenteknologi.com/solusi/get-erp-razen/img/fitur4.png" class="img-fluid position-relative z-index-1 pb-5 mb-5 ms-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="">
                    </a>
                    </div>
                </div>
                </div>
                <div class="tab-pane" id="tabsNavigationSimpleIcons5" role="tabpanel">
                <div class="row">
                    <div class="col-4">
                    <div class="text-center">
                        <p>Jadwalkan <a href="#">rapat Zoom</a> dengan mudah dan sinkronkan detail rapat. Dapatkan pemberitahuan real-time tentang aktivitas perusahaan di channel Slack Anda. </p>
                        <p>ERP memungkinkan perusahaan untuk mengoptimalkan proses bisnis mereka dan <a href="#">meningkatkan efisiensi</a> operasional, sehingga mengurangi biaya dan meningkatkan produktivitas. </p>
                    </div>
                    </div>
                    <div class="col-8">
                    <a target="_blank" href="https://razenteknologi.com/solusi/get-erp-razen/img/apphero.png">
        ...
        <div class="col-lg-4 pe-lg-0">
            ...
            <p>Kami membuat aplikasi web &amp; smartphone modern untuk membantu Anda memulai pekerjaan bisnis harian Anda. Inilah yang dikatakan pelanggan tentang pekerjaan kami.</p>
        </div>
        <div class="col-lg-8 ps-lg-4">
            ...
            <div>
                ...
                <div class="testimonial-author">
                    ...
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/clients/client-1.jpg" class="img-fluid rounded-circle" alt="">
                    </div>
                    <p>
                    <strong class="font-weight-semibold text-4 mb-1">John Smith</strong>
                    <span class="text-2">CEO</span>
                    </p>
                </div>
                </div>
            </div>
            <div>
                ...
                <div class="testimonial-author">
                    <div class="testimonial-author-thumbnail">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/clients/client-2.jpg" class="img-fluid rounded-circle" alt="">
                    </div>
                    <p>
                    <strong class="font-weight-semibold text-4 mb-1">John Doe</strong>
                    <span class="text-2">MARKETING</span>
                    </p>
                </div>
                </div>
            </div>
            <div>
                ...
                <div class="testimonial-author">
                    <div class="testimonial-author-thumbnail">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/clients/client-3.jpg" class="img-fluid rounded-circle" alt="">
                    </div>
                    <p>
                    <strong class="font-weight-semibold text-4 mb-1">John Smith</strong>
                    <span class="text-2">CEO</span>
            ...
            <div>
                ...
                <div class="testimonial-author">
                    <div class="testimonial-author-thumbnail">
                    <img src="https://razenteknologi.com/solusi/get-erp-razen/img/clients/client-4.jpg" class="img-fluid rounded-circle" alt="">
                    </div>
                    <p>
                    <strong class="font-weight-semibold text-4 mb-1">John Doe</strong>
                    <span class="text-2">MARKETING</span>
    ...
    <section class="section position-relative custom-bg-color-light-2 border-0 pt-4 m-0">
        ...
        <div class="row justify-content-center mb-3">
            ...
            <div class="overflow-hidden mb-2">
                <h2 class="font-weight-bold text-color-quaternary text-7 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Paket harga</h2>
            </div>
            <p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">Solusi manajemen penjualan dan layanan pelanggan optimal untuk perusahaan Anda </p>
            </div>
        </div>
        <div class="row pricing-table custom-pricing-table-style-1 justify-content-center mb-4">
            ...
            <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                <div class="custom-dots-rect-5" style="background-image: url(https://razenteknologi.com/solusi/get-erp-razen/img/dots-group.png);"></div>
                ...
                <p class="px-2 mb-0">Ideal untuk mencoba, solusi bisnis baru yang butuh aplikasi website saja.</p>
                </div>
                <div class="plan-features px-4">
                <ul>
                    <li>
                    <strong class="text-color-dark">20GB</strong> Penyimpanan SSD
                    </li>
                    <li>
                    <strong class="text-color-dark">100GB</strong> Bandwith Perbulan
                    </li>
                    <li>
                    <strong class="text-color-dark">1</strong> Akun Email
                    </li>
                    <li>Dukungan dan pelatihan</li>
                </ul>
                </div>
            ...
            <div class="plan plan-featured bg-color-quaternary text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
                ...
                <p class="text-color-light font-weight-light px-2 mb-0">Solusi untuk mendukung perkembangan bisnis, dapatkan aplikasi website dan smartphone yang terintegrasi .</p>
                </div>
                <div class="plan-features px-4">
                <ul>
                    <li class="text-color-light">
                    <strong class="text-color-light">50GB</strong> Penyimpanan SSD
                    </li>
                    <li class="text-color-light">
                    <strong class="text-color-light">1TB</strong> Bandwith Perbulan
                    </li>
                    <li class="text-color-light">
                    <strong class="text-color-light">5</strong> Akun Email
                    </li>
                    <li class="text-color-light">Unlimited Subdomains</li>
                    <li class="text-color-light text-bold">Dukungan dan pelatihan</li>
                </ul>
                </div>
                <div class="plan-footer pt-3 pb-5">
                <a href="kontak-kami.html" class="btn btn-light-2 btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">Pilih Paket</a>
                </div>
            </div>
            </div>
            <div class="col-md-8 col-lg-4">
            <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="620">
                <div class="plan-header bg-color-light pt-5 px-4">
                <h4 class="text-color-dark font-weight-bold text-color-quaternary text-5 mt-4 mb-2">Enterprise</h4>
                <p class="px-2 mb-0">Solusi terlengkap untuk mendukung kemajuan bisnis tanpa batas, dapatkan dukungan ekstra 24/7 dari tim kami.</p>
                </div>
                <div class="plan-features px-4">
                <ul>
                    <li>
                    <strong class="text-color-dark">100GB</strong> Penyimpanan SSD
                    </li>
                    <li>
                    <strong class="text-color-dark">1TB</strong> Bandwith Perbulan
                    </li>
                    <li>
                    <strong class="text-color-dark">Unlimited</strong> Akun Email
                    </li>
                    <li class="text-color-dark">Unlimited Subdomains</li>
                    <li>Dukungan dan pelatihan khusus</li>
                </ul>
                </div>
                <div class="plan-footer pt-3 pb-5">
                <a href="kontak-kami.html" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">Kontak Kami</a>
                </div>
            </div>
            </div>
        </div>
