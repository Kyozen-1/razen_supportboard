...
<html lang="en" data-footer="true">
    <head>
        @include('razen-supportboard.layouts.head')
    </head>

    <body>
        <div id="root">
            @include('razen-supportboard.layouts.nav')

            <main>
                @yield('content')
            </main>
            @include('razen-supportboard.layouts.footer')
        </div>
        ...
        @include('razen-supportboard.layouts.js')
    </body>
</html>
