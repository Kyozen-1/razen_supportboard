...
@section('title', 'Razen Supportboard | Paket Harga')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Supportboard | Paket Harga</h1>
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-supportboard.admin.paket-harga.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="paket_harga_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Aksi</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#paket_harga_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-supportboard.admin.paket-harga.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-supportboard.admin.paket-harga.delete', ['id' => ":user_id"]) }}";
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#paket_harga_table').DataTable().ajax.reload();
                }
            });
        });
    </script>
