...
@section('title', 'Razen Supportboard | Paket Harga | Create')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Supportboard | Paket Harga | Create</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('razen-supportboard.admin.paket-harga.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <div class="col-6" style="justify-content: center; align-self: center;">
                        <label for="" class="small-title">Tambah Paket Harga</label>
                    </div>
                ...
                <div class="mb-3 position-relative form-group">
                    ...
                    <select name="status_popular" id="status_popular" class="form-control" required>
                        <option value="">--- Status Popular ---</option>
